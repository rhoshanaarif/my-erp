...
!(function (e) {
  ...
  var t = (function () {
      ...
      var n, i, r, o, s, a, l, c, u, d, p, h, f, g, m, v;
      function y(e, t) {
        return f.call(e, t);
      }
      function _(e, t) {
        ...
        if (e) {
          for (
            s = (e = e.split("/")).length - 1,
              p.nodeIdCompat && m.test(e[s]) && (e[s] = e[s].replace(m, "")),
              "." === e[0].charAt(0) &&
                f &&
      ...
      function A(e) {
        ...
        if (!y(u, e) && !y(h, e)) throw new Error("No " + e);
        return u[e];
      }
      function x(e) {
        var t,
        ...
        (t && t.requirejs) ||
          ...
          (s = function (e, t, n, i) {
            var r,
              ...
              v = [],
              _ = typeof n;
            if (((g = D((i = i || e))), "undefined" == _ || "function" == _)) {
              for (
                t =
                ...
                if ("require" === (s = (p = l(t[f], g)).f)) v[f] = c.require(e);
                else if ("exports" === s) (v[f] = c.exports(e)), (m = !0);
                else if ("module" === s) r = v[f] = c.module(e);
                else if (y(u, s) || y(d, s) || y(h, s)) v[f] = A(s);
                else {
                  if (!p.p) throw new Error(e + " missing " + s);
                  p.p.load(p.n, w(i, !0), b(s), {}), (v[f] = u[s]);
                }
              (a = n ? n.apply(u[e], v) : void 0),
                e &&
                  (r && r.exports !== o && r.exports !== u[e]
                    ? (u[e] = r.exports)
                    : (a === o && m) || (u[e] = a));
            } else e && (u[e] = n);
          }),
              ...
              this.data.current(function (i) {
                ...
                n.$results
                  ...
                  .each(function () {
                    ...
                    (null == i.element && -1 < e.inArray(o, r))
          ...
          return (
            ...
            (e.prototype._checkIfMaximumSelected = function (e, t) {
              ...
              this.current(function (e) {
                ...
                0 < n.maximumSelectionLength && i >= n.maximumSelectionLength
