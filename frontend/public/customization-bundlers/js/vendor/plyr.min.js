  ...
  (function (e, t) {
    ...
    var N,
      ...
      I = (function () {
        function e(t, n) {
          (function (e, t) {
            ...
            S(t)
              ? (this.element = t)
              : T(t) && (this.element = document.querySelector(t)),
            S(this.element) &&
              E(this.element.rangeTouch) &&
              ((this.config = p({}, f, {}, n)), this.init());
        }
        return (
          (function (e, t, n) {
      ...
      R = function (e) {
        return (
          _(e) ||
          ((D(e) || H(e) || F(e)) && !e.length) ||
          (j(e) && !Object.keys(e).length)
        );
      },
      V = _,
      B = j,
      ...
      G = function (e) {
        return O(e, TextTrack) || (!_(e) && D(e.kind));
      },
      Z = function (e) {
      ...
      te =
        ...
        (x = Object.keys(M).find(function (e) {
          return void 0 !== N.style[e];
        })),
        !!W(x) && M[x]);
    function ne(e, t) {
      setTimeout(function () {
    ...
    function le(e, t, n) {
      ...
      return B(t) && se(i, t), W(n) && (i.innerText = n), i;
    }
    function ce(e, t, n, i) {
      X(t) && t.appendChild(le(e, n, i));
    }
    function ue(e) {
      Q(e) || Y(e)
        ? Array.from(e).forEach(ue)
        : X(e) && X(e.parentNode) && e.parentNode.removeChild(e);
    }
    function de(e) {
      if (X(e))
    ...
    var ke,
      ...
      Ce = {
        ...
        pip: !(
          ie.isIPhone ||
          (!K(le("video").webkitSetPresentationMode) &&
    ...
    function Se(e, t, n) {
      ...
      if (e && "addEventListener" in e && !ee(t) && K(n)) {
        var s = t.split(" "),
          l = o;
        Ae && (l = { passive: r, capture: o }),
    ...
    function Ie() {
      ...
      return new Promise(function (t) {
        return e.ready
          ? setTimeout(t, 0)
          : Pe.call(e, e.elements.container, "ready", t);
      }).then(function () {});
    }
    function Le(e) {
      (function (e) {
        return O(e, Promise) && q(e.then);
      })(e) && e.then(null, function () {});
    }
    function Oe(e) {
      return (
        !!(Y(e) || (W(e) && e.includes(":"))) &&
        (Y(e) ? e : e.split(":")).map(Number).every(U)
      );
    }
    function _e(e) {
      if (!Y(e) || !e.every(U)) return null;
      var t = s(e, 2),
        n = t[0],
        i = t[1],
        a = (function e(t, n) {
    ...
    function je(e) {
      ...
      if (
        ...
        var i = this.media;
        n = _e([i.videoWidth, i.videoHeight]);
      }
      return n;
    }
    function De(e) {
    ...
    var We = {
      ...
      ze = function () {
        ...
        if (ee(e) || ee(t)) return "";
        var n = ae(t.i18n, e);
        if (ee(n)) return Object.keys(We).includes(e) ? We[e] : "";
        ...
        function e(n) {
          ...
          t(this, e),
            a(this, "get", function (t) {
              ...
              if (ee(n)) return null;
              var a = JSON.parse(n);
              return W(t) && t.length ? a[t] : a;
            }),
            a(this, "set", function (t) {
              if (e.supported && i.enabled && B(t)) {
                var n = i.get();
                ee(n) && (n = {}),
                  re(n, t),
    ...
    var Ze = {
      ...
      findElements: function () {
        try {
          return (
            (this.elements.controls = ve.call(
              this,
            ...
            (this.elements.progress = ve.call(
              this,
      ...
      createIcon: function (e, t) {
        ...
        se(r, re(t, { "aria-hidden": "true", focusable: "false" }));
      ...
      createButton: function (e, t) {
        var n = this,
          ...
          a = (function () {
            ...
            return (e = Be(e)).charAt(0).toLowerCase() + e.slice(1);
          })(e),
          r = {
            element: "button",
            toggle: !1,
        ...
        switch (
          ...
          case "play-large":
            ...
            break;
          default:
            ee(r.label) && (r.label = a), ee(r.icon) && (r.icon = e);
        }
        var o = le(r.element);
        return (
          r.toggle
            ? (o.appendChild(
              ...
              o.appendChild(
                Ze.createIcon.call(this, r.icon, { class: "icon--not-pressed" })
              ),
              o.appendChild(
            ...
            : (o.appendChild(Ze.createIcon.call(this, r.icon)),
              o.appendChild(Ze.createLabel.call(this, r.label))),
          re(i, me(this.config.selectors.buttons[a], i)),
          se(o, i),
          "play" === a
            ? (Y(this.elements.buttons[a]) || (this.elements.buttons[a] = []),
      ...
      createRange: function (e, t) {
        var n = le(
          "input",
          re(
            me(this.config.selectors.inputs[e]),
            {
              type: "range",
              min: 0,
              max: 100,
      ...
      createProgress: function (e, t) {
        var n = le(
          "progress",
          re(
            me(this.config.selectors.display[e]),
            {
              min: 0,
              max: 100,
              value: 0,
        ...
        Pe.call(
          ...
          function (i) {
            if (
              ...
              var a,
                r = ye(e, '[role="menuitemradio"]');
              !r && [32, 39].includes(i.which)
                ? Ze.showMenuPanel.call(n, t, !0)
                : 32 !== i.which &&
                  (40 === i.which || (r && 39 === i.which)
                    ? ((a = e.nextElementSibling),
                      X(a) || (a = e.parentNode.firstElementChild))
                    : ((a = e.previousElementSibling),
                      X(a) || (a = e.parentNode.lastElementChild)),
                  we.call(n, a, !0));
            }
          },
          !1
        ),
          Pe.call(this, e, "keyup", function (e) {
          ...
          this.listeners.bind(
            ...
            function (e) {
              if (!J(e) || 32 === e.which) {
                ...
                Ze.showMenuPanel.call(t, "home", J(e));
              }
            },
            a,
            !1
          ),
          Ze.bindMenuItemShortcuts.call(this, d, a),
          i.appendChild(d);
      },
      formatTime: function () {
        var e =
      ...
      updateTimeDisplay: function () {
        var e =
          ...
          n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
        X(e) && U(t) && (e.innerText = Ze.formatTime(t, n));
      },
      updateVolume: function () {
        this.supported.ui &&
          (X(this.elements.inputs.volume) &&
            Ze.setRange.call(
              this,
              this.elements.inputs.volume,
              this.muted ? 0 : this.volume
            ),
          X(this.elements.buttons.mute) &&
                ...
                (n = this.currentTime),
                  ...
                  (a =
                    0 === n || 0 === i || Number.isNaN(n) || Number.isNaN(i)
                      ...
                      : ((n / i) * 100).toFixed(2)),
                  "timeupdate" === e.type &&
                    Ze.setRange.call(this, this.elements.inputs.seek, a);
                break;
              case "playing":
              case "progress":
                !(function (e, n) {
      ...
      updateSeekTooltip: function (e) {
        ...
        if (
          ...
          X(this.elements.inputs.seek) &&
          X(this.elements.display.seekTooltip) &&
          0 !== this.duration
        ) {
          ...
          if (this.touch) i(!1);
            ...
            if ($(e)) a = (100 / r.width) * (e.pageX - r.left);
            else {
      ...
      updateSetting: function (e, t, n) {
        ...
        if ("captions" === e) a = this.currentTrack;
          ...
          if (
            ((a = ee(n) ? this[e] : n),
            ee(a) && (a = this.config[e].default),
            !ee(this.options[e]) && !this.options[e].includes(a))
          )
        ...
        if ((X(r) || (r = i && i.querySelector('[role="menu"]')), X(r))) {
          ...
          ).innerHTML = Ze.getLabel.call(this, e, a);
      ...
      getLabel: function (e, t) {
        switch (e) {
          case "speed":
            return 1 === t
              ? ze("normal", this.config)
              : "".concat(t, "&times;");
          case "quality":
            if (U(t)) {
              var n = ze("qualityLabel.".concat(t), this.config);
      ...
      setQualityMenu: function (e) {
        ...
        if (X(this.elements.settings.panels.quality)) {
          ...
          Y(e) &&
            (this.options.quality = He(e).filter(function (e) {
              return t.config.quality.options.includes(e);
            }));
          var a = !ee(this.options.quality) && this.options.quality.length > 1;
          if (
            (Ze.toggleMenuButton.call(this, n, a),
            de(i),
            Ze.checkMenu.call(this),
            a)
          ) {
            var r = function (e) {
              var n = ze("qualityBadge.".concat(e), t.config);
      ...
      setCaptionsMenu: function () {
        ...
        if (X(this.elements.settings.panels.captions)) {
          var t = "captions",
            ...
            a = Boolean(i.length);
          if (
            (Ze.toggleMenuButton.call(this, t, a),
            de(n),
            Ze.checkMenu.call(this),
            a)
          ) {
      ...
      toggleMenu: function (e) {
        ...
        if (X(t) && X(n)) {
          var i = t.hidden,
            a = i;
          if (z(e)) a = e;
          else if (J(e) && 27 === e.which) a = !1;
          else if ($(e)) {
            var r = K(e.composedPath) ? e.composedPath()[0] : e.target,
              o = t.contains(r);
            if (o || (!o && e.target !== n && a)) return;
          }
          n.setAttribute("aria-expanded", a),
            pe(t, !a),
            fe(this.elements.container, this.config.classNames.menu.open, a),
            a && J(e)
              ? Ze.focusFirstMenuItem.call(this, null, !0)
              : a || i || we.call(this, n, J(e));
        }
      },
      ...
      showMenuPanel: function () {
        ...
        if (X(i)) {
          ...
          if (Ce.transitions && !Ce.reducedMotion) {
            ...
            var o = Ze.getMenuSize.call(this, i),
              s = function t(n) {
                n.target === a &&
          ...
          pe(r, !0), pe(i, !1), Ze.focusFirstMenuItem.call(this, i, n);
        }
      },
      ...
      create: function (e) {
        ...
        return (
          He(Y(this.config.controls) ? this.config.controls : []).forEach(
            function (s) {
              if (
                ...
                if (
                  ...
                  p.appendChild(
                    r.call(
                      t,
                      "volume",
                      re(f, { id: "plyr-volume-".concat(e.id) })
                    )
                  );
                }
              }
              if (
                ...
                "settings" === s && !ee(t.config.settings))
              ) {
                var g = le(
                  "div",
                  re({}, d, {
                ...
                var y = le("div", {
                  ...
                  b = le("div"),
                  v = le("div", { id: "plyr-settings-".concat(e.id, "-home") }),
                  w = le("div", { role: "menu" });
                v.appendChild(w),
                  b.appendChild(v),
                  ...
                  t.config.settings.forEach(function (i) {
                    var a = le(
                      "button",
                      re(me(t.config.selectors.buttons.settings), {
                        type: "button",
                        class: ""
                    ...
                    n.call(t, a, i),
                      Pe.call(t, a, "click", function () {
                        c.call(t, i, !1);
                      });
                    var r = le("span", null, ze(i, t.config)),
                      o = le("span", { class: t.config.classNames.menu.value });
                    (o.innerHTML = e[i]),
                      r.appendChild(o),
                      a.appendChild(r),
                      w.appendChild(a);
                    ...
                    l.appendChild(
                      le("span", { "aria-hidden": !0 }, ze(i, t.config))
                    ),
                      l.appendChild(
                        le(
                          "span",
                          { class: t.config.classNames.hidden },
                          ze("menuBack", t.config)
                        )
                      ),
                      Pe.call(
                        t,
                      ...
                      Pe.call(t, l, "click", function () {
                        c.call(t, "home", !1);
                      }),
                      s.appendChild(l),
                      s.appendChild(le("div", { role: "menu" })),
                      b.appendChild(s),
              ...
              if (
                ("pip" === s && Ce.pip && u.appendChild(i.call(t, "pip", d)),
                "airplay" === s &&
                  Ce.airplay &&
          ...
          this.isHTML5 && s.call(this, qe.getQualityOptions.call(this)),
          l.call(this),
          u
        );
      },
      inject: function () {
        ...
        if (
          ...
          X(this.config.controls) || W(this.config.controls)
          ...
          o &&
            ...
            (n = i)),
          W(this.config.selectors.controls.container) &&
            (a = document.querySelector(
              this.config.selectors.controls.container
            )),
          X(a) || (a = this.elements.container),
          a[X(n) ? "insertAdjacentElement" : "insertAdjacentHTML"](
            "afterbegin",
            n
          ),
          ...
          Object.values(this.elements.buttons)
            .filter(Boolean)
            .forEach(function (e) {
              Y(e) || Q(e) ? Array.from(e).filter(Boolean).forEach(l) : l(e);
            });
        }
        ...
        setup: function () {
          if (this.supported.ui)
            if (
              ...
              if (
                (X(this.elements.captions) ||
                  ((this.elements.captions = le(
                    "div",
                    me(this.config.selectors.captions)
                  )),
                  (function (e, t) {
              ...
              if (
                (z(i) || (i = this.config.captions.active),
                ...
                var a = this.config.captions.update
                  ...
                  : "removetrack";
                Pe.call(this, this.media.textTracks, a, nt.update.bind(this));
              }
            ...
            t
              ...
              .forEach(function (t) {
                e.debug.log("Track added", t),
                  ...
                  Pe.call(e, t, "cuechange", function () {
                    return nt.updateCues.call(e);
                  });
              }),
            ((s && this.language !== a) || !t.includes(o)) &&
              (nt.setLanguage.call(this, a), nt.toggle.call(this, i && s)),
            fe(
            ...
            if (r !== i) {
              if (
                ...
                return (
                  ...
                  void nt.set.call(this, o.indexOf(s))
                );
              }
              this.elements.buttons.captions &&
                (this.elements.buttons.captions.pressed = r),
                fe(this.elements.container, a, r),
        ...
        setLanguage: function (e) {
          ...
          if (W(e)) {
            ...
            var i = nt.getTracks.call(this),
              a = nt.findTrack.call(this, [n]);
            nt.set.call(this, i.indexOf(a), t);
        ...
        getLabel: function (e) {
          ...
          return (
            ...
            G(t)
              ? ee(t.label)
                ? ee(t.language)
                  ? ze("enabled", this.config)
                  : e.language.toUpperCase()
                : t.label
              : ze("disabled", this.config)
          );
        },
          ...
          t(this, e),
            ...
            a(this, "toggleFallback", function () {
              ...
              if (
                ...
                fe(i.target, i.player.config.classNames.fullscreen.fallback, e),
                ie.isIos)
              ) {
                ...
                var a = W(t.content) && t.content.includes(n);
                e
                  ? ((i.cleanupViewport = !a),
            ...
            a(this, "enter", function () {
              i.enabled &&
                (ie.isIos && i.player.config.fullscreen.iosNative
                  ? i.player.isVimeo
            ...
            a(this, "exit", function () {
              if (i.enabled)
                if (ie.isIos && i.player.config.fullscreen.iosNative)
                  i.target.webkitExitFullscreen(), Le(i.player.play());
                ...
                get: function () {
                  ...
                  return (
                    ["webkit", "moz", "ms"].some(function (t) {
                      return !(
                        (!K(document["".concat(t, "ExitFullscreen")]) &&
                          !K(document["".concat(t, "CancelFullScreen")])) ||
                        ((e = t), 0)
                      );
                    }),
                    e
    ...
    var dt = {
        ...
        build: function () {
          ...
          X(this.elements.controls) ||
            ...
            fe(this.elements.container, this.config.classNames.isIos, ie.isIos),
            fe(
              this.elements.container,
            ...
            this.poster &&
              dt.setPoster.call(this, this.poster, !1).catch(function () {}),
            this.config.duration && Ze.durationUpdate.call(this);
        },
        setTitle: function () {
          var e = ze("play", this.config);
          if (
            (W(this.config.title) &&
          ...
          fe(
            ...
            Array.from(this.elements.buttons.play || []).forEach(function (e) {
              Object.assign(e, { pressed: t.playing }),
                e.setAttribute(
                  "aria-label",
                  ze(t.playing ? "pause" : "play", t.config)
                );
            }),
            ($(e) && "timeupdate" === e.type) || dt.toggleControls.call(this);
        },
        ...
        migrateStyles: function () {
          ...
          Object.values(o({}, this.media.style))
            .filter(function (e) {
              return !ee(e) && W(e) && e.startsWith("--plyr");
            })
            .forEach(function (t) {
          ...
          t(this, e),
            ...
            a(this, "global", function () {
              ...
              t.config.keyboard.global &&
                Se.call(t, window, "keydown keyup", i.handleKey, e, !1),
                Se.call(t, document.body, "click", i.toggleMenu, e),
                Ne.call(t, document.body, "touchstart", i.firstTouch),
                Se.call(
                  t,
                  document.body,
            ...
            a(this, "container", function () {
              ...
              !t.keyboard.global &&
                t.keyboard.focused &&
                Pe.call(e, n.container, "keydown keyup", i.handleKey, !1),
                Pe.call(
                  e,
                  n.container,
            ...
            a(this, "media", function () {
              var e = i.player,
                t = e.elements;
              if (
                (Pe.call(e, e.media, "timeupdate seeking seeked", function (t) {
                  return Ze.timeUpdate.call(e, t);
                }),
                Pe.call(
                  e,
                  e.media,
                  ...
                  function (t) {
                    return Ze.durationUpdate.call(e, t);
                  }
                ),
                ...
                Pe.call(
                  ...
                  function (t) {
                    return Ze.updateProgress.call(e, t);
                  }
                ),
                Pe.call(e, e.media, "volumechange", function (t) {
                  return Ze.updateVolume.call(e, t);
                }),
                Pe.call(
                  e,
                  e.media,
              ...
              e.supported.ui &&
                ...
                Pe.call(e, e.media, "volumechange", function () {
              ...
              Pe.call(e, e.media, a, function (n) {
                ...
                "error" === n.type && (a = e.media.error),
                  Me.call(e, t.container, n.type, !0, a);
              });
            }),
            a(this, "proxy", function (e, t, n) {
              var a = i.player,
                ...
                o = !0;
              K(r) && (o = r.call(a, e)), !1 !== o && K(t) && t.call(a, e);
            }),
            ...
            a(this, "controls", function () {
              ...
              i.bind(
                ...
                i.bind(
                  ...
                  function (t) {
                    return Ze.updateSeekTooltip.call(e, t);
                  }
                ),
                ...
                ie.isWebkit &&
                  Array.from(be.call(e, 'input[type="range"]')).forEach(
                    function (t) {
                      i.bind(t, "input", function (t) {
                        return Ze.updateRangeFill.call(e, t.target);
                      });
                    }
                  ),
                e.config.toggleInvert &&
                  !X(t.display.duration) &&
                ...
                i.bind(t.controls, "focusin", function () {
                  var n = e.config,
                    a = e.timers;
                  fe(t.controls, n.classNames.noTransition, !0),
                    dt.toggleControls.call(e, !0),
                    setTimeout(function () {
          ...
          i(e, [
            {
              ...
              value: function (e) {
                var t = this.player,
                  ...
                  a = "keydown" === e.type,
                  r = a && i === this.lastKey;
                if (!(e.altKey || e.ctrlKey || e.metaKey || e.shiftKey) && U(i))
                  if (a) {
                    var o = document.activeElement;
                    if (X(o)) {
                      var s = t.config.selectors.editable;
                      if (o !== n.inputs.seek && ye(o, s)) return;
                      if (32 === e.which && ye(o, 'button, [role^="menuitem"]'))
                        return;
                    }
                    switch (
                      ([
      ...
      ready: function () {
        ...
        var u,
          d = ee((u = c))
            ...
            : u,
          h = le("iframe"),
          m = Fe(t.config.urls.vimeo.iframe, d, l);
        if (
          ...
          ee(a) || h.setAttribute("referrerPolicy", a),
          i || !n.customControls)
        )
          h.setAttribute("data-poster", t.poster), (t.media = he(h, t.media));
        else {
          var p = le("div", {
        ...
        n.customControls ||
          Ye(Fe(t.config.urls.vimeo.api, m)).then(function (e) {
            !ee(e) &&
              e.thumbnail_url &&
              dt.setPoster.call(t, e.thumbnail_url).catch(function () {});
          }),
        ...
        Object.defineProperty(t.media, "loop", {
          ...
          set: function (e) {
            var n = z(e) ? e : t.config.loop.active;
          ...
          t.embed.on("loaded", function () {
            t.embed.getPaused().then(function (e) {
              ft.call(t, !e), e || Me.call(t, t.media, "playing");
            }),
              X(t.embed.element) &&
                t.supported.ui &&
          ...
          t.embed.on("play", function () {
            ft.call(t, !0), Me.call(t, t.media, "playing");
          }),
          ...
          t.embed.on("timeupdate", function (e) {
            (t.media.seeking = !1),
              (f = e.seconds),
              Me.call(t, t.media, "timeupdate");
          }),
          t.embed.on("progress", function (e) {
            (t.media.buffered = e.percent),
              Me.call(t, t.media, "progress"),
              1 === parseInt(e.percent, 10) &&
                Me.call(t, t.media, "canplaythrough"),
              t.embed.getDuration().then(function (e) {
                e !== t.media.duration &&
                  ((t.media.duration = e),
                  Me.call(t, t.media, "durationchange"));
              });
          }),
      ...
      wt = {
        setup: function () {
          ...
          if (
            ...
            B(window.YT) && K(window.YT.Player))
          )
            wt.ready.call(this);
          else {
            var t = window.onYouTubeIframeAPIReady;
            (window.onYouTubeIframeAPIReady = function () {
              K(t) && t(), wt.ready.call(e);
            }),
        ...
        getTitle: function (e) {
          var t = this;
          Ye(Fe(this.config.urls.youtube.api, e))
            .then(function (e) {
              if (B(e)) {
                var n = e.title,
                  i = e.height,
          ...
          this.media
            ? (fe(
              ...
              this.isHTML5
                ...
                : this.isYouTube
                ? wt.setup.call(this)
                : this.isVimeo && gt.setup.call(this))
        ...
        function e(n) {
          ...
          t(this, e),
            a(this, "load", function () {
              i.enabled &&
                (B(window.google) && B(window.google.ima)
                  ? i.ready()
                  : pt(i.player.config.urls.googleIMA.sdk)
                      .then(function () {
                        i.ready();
                      })
                      .catch(function () {
            ...
            a(this, "pollCountdown", function () {
              ...
              var t = function () {
                var e = Ge(Math.max(i.manager.getRemainingTime(), 0)),
                  t = ""
                    .concat(ze("advertisement", i.player.config), " - ")
                    .concat(e);
            ...
            a(this, "on", function (e, t) {
              return (
                Y(i.events[e]) || (i.events[e] = []), i.events[e].push(t), i
              );
            }),
        ...
        function e(n) {
          ...
          t(this, e),
                ...
                if ("touchmove" === e.type)
                  ...
                  (i.seekTime = i.player.media.duration * (n / 100)),
                    ...
                    i.seekTime > i.player.media.duration - 1 &&
                      (i.seekTime = i.player.media.duration - 1),
                    (i.mousePosX = e.pageX),
                    (i.elements.thumb.time.innerText = Ge(i.seekTime));
                }
            ...
            a(this, "startScrubbing", function (e) {
              (V(e.button) || !1 === e.button || 0 === e.button) &&
                ((i.mouseDown = !0),
                i.player.media.duration &&
              ...
              this.destroy.call(
                ...
                function () {
                  ...
                  Object.assign(t, {
                    provider: o,
                    type: i,
                    supported: Ce.check(i, o, t.config.playsinline),
                    media: le(c, u),
                  }),
                    t.elements.container.appendChild(t.media),
                    z(e.autoplay) && (t.config.autoplay = e.autoplay),
                    t.isHTML5 &&
        ...
        function e(n, i) {
          ...
          if (
              ...
              return K(r.media.play)
                ? (r.ads &&
                    ...
                    r.ads.managerPromise
                      ...
                      .catch(function () {
                        return Le(r.media.play());
                      }),
                  r.media.play())
                : null;
            }),
            a(this, "pause", function () {
              return r.playing && K(r.media.pause) ? r.media.pause() : null;
            }),
            a(this, "togglePlay", function (e) {
              return (z(e) ? e : !r.playing) ? r.play() : r.pause();
            }),
            a(this, "stop", function () {
              r.isHTML5
                ? (r.pause(), r.restart())
                : K(r.media.stop) && r.media.stop();
            }),
            a(this, "restart", function () {
              r.currentTime = 0;
            }),
            a(this, "rewind", function (e) {
              r.currentTime -= U(e) ? e : r.config.seekTime;
            }),
            ...
            a(this, "airplay", function () {
              Ce.airplay && r.media.webkitShowPlaybackTargetPicker();
            }),
              ...
              if (r.supported.ui && !r.isAudio) {
                ...
                if (
                  (i &&
                    ...
                    !ee(r.config.settings) &&
                    Ze.toggleMenu.call(r, !1),
                  i !== t)
                ) {
            ...
            a(this, "on", function (e, t) {
              Pe.call(r, r.elements.container, e, t);
            }),
            a(this, "once", function (e, t) {
              Ne.call(r, r.elements.container, e, t);
            }),
            a(this, "off", function (e, t) {
              Ee(r.elements.container, e, t);
            }),
            a(this, "destroy", function (e) {
              ...
              if (r.ready) {
                  ...
                  (document.body.style.overflow = ""),
                    ...
                    t
                      ? (Object.keys(r.elements).length &&
                          (ue(r.elements.buttons.play),
                          ue(r.elements.captions),
                          ue(r.elements.controls),
                          ue(r.elements.wrapper),
                        ...
                        K(e) && e())
                      : (xe.call(r),
                        qe.cancelRequests.call(r),
                        he(r.elements.original, r.elements.container),
                        Me.call(r, r.elements.original, "destroyed", !0),
                        K(e) && e.call(r.elements.original),
                        (r.ready = !1),
                        setTimeout(function () {
                ...
                r.stop(),
                  ...
                  r.isHTML5
                    ? (dt.toggleNativeControls.call(r, !0), n())
                    : r.isYouTube
                ...
                (this.supported = Ce.check(
                  ...
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      (this.storage = new Ke(this)),
                      (this.media.plyr = this),
                      X(this.elements.container) ||
                        ((this.elements.container = le("div", { tabindex: 0 })),
                      ...
                      this.config.previewThumbnails.enabled &&
                        (this.previewThumbnails = new At(this)))
            ...
            [
              ...
              },
              {
                ...
                set: function (e) {
                  var t = e;
                  W(t) && (t = Number(t)),
                    U(t) || (t = this.storage.get("volume")),
                    U(t) || (t = this.config.volume),
                    t > 1 && (t = 1),
                    t < 0 && (t = 0),
              ...
              },
              {
                ...
                set: function (e) {
                  var t = e;
                  z(t) || (t = this.storage.get("muted")),
                    z(t) || (t = this.config.muted),
                    (this.config.muted = t),
                    (this.media.muted = t);
                },
                get: function () {
              ...
              },
              {
                ...
                set: function (e) {
                  ...
                  U(e) && (n = e),
                    ...
                    U(n) || (n = this.config.speed.selected);
              ...
              },
              {
                key: "loop",
                set: function (e) {
                  var t = z(e) ? e : this.config.loop.active;
              ...
              },
              {
                key: "autoplay",
                set: function (e) {
                  var t = z(e) ? e : this.config.autoplay;
              ...
              },
              {
                ...
                set: function (e) {
                  if (Ce.pip) {
                    var t = z(e) ? e : !this.pip;
                    K(this.media.webkitSetPresentationMode) &&
                      this.media.webkitSetPresentationMode(t ? at : "inline"),
                ...
                get: function () {
                  return Ce.pip
                    ? ee(this.media.webkitPresentationMode)
                      ...
                      : this.media.webkitPresentationMode === at
                    : null;
                },
              },
            ],
    ...
    return (Pt.defaults = ((vt = it), JSON.parse(JSON.stringify(vt)))), Pt;
  });
