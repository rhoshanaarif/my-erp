...
var FullCalendar = (function (e) {
  ...
  function hn(e, t, n, r) {
    for (
      var o = { defs: {}, instances: {} }, i = Mn(n), a = 0, s = e;
      a < s.length;
      a++
    ) {
  ...
  var Rn = { id: String, groupId: String, title: String, url: String },
    _n = { start: fn, end: fn, date: fn, allDay: Boolean },
    Tn = r(r(r({}, Rn), _n), { extendedProps: fn });
  ...
  function Bn(e, t, n, r) {
    ...
    for (var m in o)
      for (var y = 0, E = An(o[m], n); y < E.length; y++) {
        var S,
          D = E[y];
        (f = u[(S = a[m]).defId]),
          s.push({
    ...
    for (var c in i)
      for (var b = 0, C = An(i[c], n); b < C.length; b++)
        (D = C[b]),
          s.push({
            def: e.defs[c],
            ui: u[c],
  ...
  function dr(e, t) {
    ...
    return (
      r(
        ...
        ((n = e),
        (o = t.dateEnv),
        r(r({}, lr(n.range, o, n.allDay)), { allDay: n.allDay }))
      ),
      i
    );
  }
  ...
  function vr(e, t, n, o, i) {
    ...
    return (
      ...
      u.range.end < u.range.start &&
        (u.range.end = pr(t.allDay, u.range.start, i)),
      u
    );
  }
  var gr = (function () {
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in _n)
            ...
            (t = Rn[e](t)), this.mutate({ standardProps: { publicId: t } });
          else if (e in Rn)
            (t = Rn[e](t)),
      ...
      return (
        (e.prototype.splitProps = function (e) {
          ...
          for (var c in ((this.eventUiBuilders = gt(n, function (e, n) {
            return t.eventUiBuilders[n] || Ft(Yr);
          })),
          n)) {
            var d = n[c],
              p = a[c] || Gr,
          ...
          if (e) {
            var n = this._splitEventStore(
              ...
              i = function (r) {
                t[r] ||
                  (t[r] = {
                    affectedEvents: n[r] || Gr,
                    mutatedEvents: o[r] || Gr,
                    isEvent: e.isEvent,
                  });
              };
            for (var a in n) i(a);
  ...
  function ro(e, t, n) {
    void 0 === t && (t = !1);
    var r = n ? e.getBoundingClientRect() : oo(e),
      o = no(e, t),
      i = {
  ...
  if (
    ...
    (fo.prototype.baseIconClass = ""),
    (fo.prototype.iconOverridePrefix = ""),
  ...
  var ho = FullCalendarVDom.Component,
    vo = FullCalendarVDom.createElement,
    go = FullCalendarVDom.render,
    mo = FullCalendarVDom.createRef,
    yo = FullCalendarVDom.Fragment,
    Eo = FullCalendarVDom.createContext,
    So = FullCalendarVDom.createPortal,
    Do = FullCalendarVDom.flushToDom,
    bo = FullCalendarVDom.unmountComponentAtNode,
    Co = (function () {
      function e(e, t, n, o) {
        var i = this;
        (this.execFunc = e),
  ...
  function Ro(e, t, n, r, o, i, a, s, l, u, c, d, p) {
    return {
      ...
      createScrollResponder: function (e) {
        return new Co(e, u, kt(n.scrollTime), n.scrollTimeReset);
      },
  ...
  var To = (function (e) {
    ...
    return n(t, e), (t.contextType = wo), t;
  })(_o);
  function ko(e) {
  ...
  var Oo = (function (e) {
      function t() {
        ...
        return (
          ...
          (t.handleRootEl = function (e) {
            Mo(t.rootElRef, e), t.props.elRef && Mo(t.props.elRef, e);
          }),
          t
        );
      }
          ...
          return vo(
            ...
            function (r) {
              return vo(
                ...
                function (e, o) {
                  return t.children(r, Fo(t.classNames, n), e, o);
                }
              );
            }
          );
    ...
    Ao = Eo(0);
  function Uo(e) {
    return vo(Ao.Consumer, null, function (t) {
      return vo(Lo, r({ renderId: t }, e));
    });
  }
  var Lo = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.innerElRef = mo()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
        ...
        (t.prototype.renderInnerContent = function () {
          var e = this.context.pluginHooks.contentTypeHandlers,
            ...
            i = null;
          if (
            (void 0 === o && (o = zo(t.defaultContent, t.hookProps)),
            void 0 !== o)
          ) {
    ...
    Wo = (function (e) {
      function t() {
        ...
        return (
          (t.handleRootEl = function (e) {
            (t.rootEl = e), t.props.elRef && Mo(t.props.elRef, e);
          }),
          t
        );
      }
  ...
  function Vo() {
    ...
    return function (r, o) {
      return (
        (t && Et(t, o) && r === e) || ((e = r), (t = o), (n = Fo(r, o))), n
      );
    };
  }
  function Fo(e, t) {
  ...
  function zo(e, t) {
    return "function" == typeof e ? e(t, vo) : e;
  }
  var Bo = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
  ...
  function Go(e) {
    ...
    return (
      n.content &&
        ((t = n),
        (o = function (e) {
          return vo(wo.Consumer, null, function (n) {
            return vo(Bo, { viewSpec: n.viewSpec }, function (o, i) {
              var a = r(r({}, e), {
  ...
  function qo(e, t, n, o) {
    ...
    return gt(
      (function (e, t) {
        var n,
          r = {};
        for (n in e) Ho(n, r, e, t);
        for (n in t) Ho(n, r, e, t);
        return r;
      })(i, a),
      function (e) {
          ...
          if (
            ...
            (s = (function (e) {
              var t = JSON.stringify(e),
                n = Yo[t];
              return void 0 === n && ((n = kt(e)), (Yo[t] = n)), n;
            })(a))
          ) {
            var d = Ot(s);
            (l = d.unit),
      ...
      return (
        ...
        (e.prototype.build = function (e, t, n) {
          ...
          return (
            ...
            d.showNonCurrentDates || (s = Ln(s, o.range)),
            (s = Ln((s = this.adjustActiveRange(s)), r)),
            (l = Vn(o.range, r)),
            {
              validRange: r,
  ...
  function li(e, t, n, r, o) {
    ...
    return {
      headerToolbar: e.headerToolbar
        ? ui(e.headerToolbar, e, t, n, r, o, i)
        : null,
      footerToolbar: e.footerToolbar
        ? ui(e.footerToolbar, e, t, n, r, o, i)
        : null,
      viewsWithButtons: i,
    };
  }
      ...
      eventSourceDefs: [
        {
          ...
          fetch: function (e, t, n) {
            ...
            ao(
              e.eventSource.meta.bind(null, sr(e.range, r)),
              function (e) {
                t({ rawEvents: e });
              },
              n
    ...
    Po({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            r(r({}, sr(e.activeRange, t.dateEnv)), { view: t.viewApi })
          );
        },
    ...
    mi = (function () {
      function e(e, t) {
        (this.runTaskOption = e),
          ...
          (this.queue = []),
          (this.delayedRunner = new gi(this.drain.bind(this)));
      }
      return (
  ...
  var Ei = (function () {
    function e(e) {
      ...
      (this.computeOptionsData = Ft(this._computeOptionsData)),
        ...
        (this.organizeRawLocales = Ft(Pr)),
        (this.buildLocale = Ft(Nr)),
        ...
        (this.buildDateEnv = Ft(Si)),
        (this.buildTheme = Ft(Di)),
        (this.parseToolbars = Ft(li)),
        (this.buildViewSpecs = Ft(qo)),
        (this.buildDateProfileGenerator = zt(bi)),
        (this.buildViewApi = Ft(Ci)),
        (this.buildViewUiProps = zt(_i)),
        (this.buildEventUiBySource = Ft(wi, Et)),
        (this.buildEventUiBases = Ft(Ri)),
        (this.parseContextBusinessHours = zt(ki)),
        (this.buildTitle = Ft(yi)),
        (this.emitter = new so()),
        (this.actionRunner = new mi(
      ...
      var s,
        ...
        c =
          ((s = o.calendarOptions),
          (l = o.dateEnv),
          null != (u = s.initialDate) ? l.createMarker(u) : Sr(s.now, l)),
      ...
      Ti(g, p) && this.emitter.trigger("loading", !0),
        (this.state = g),
        this.updateData(),
        ...
        this.data &&
          ...
          (p = (function (e, t, n, r) {
            ...
            switch (t.type) {
              ...
              case "CHANGE_DATE":
                if (!e.activeRange || !zn(e.currentRange, t.dateMarker))
          ...
          zn(p.currentRange, d) || (d = p.currentRange.start);
        for (
          var f = (function (e, t, n, o) {
              ...
              switch (t.type) {
                ...
                case "FETCH_EVENT_SOURCES":
                  return Jo(
                    e,
                    t.sourceIds ? mt(t.sourceIds) : ei(e, o),
                    s,
                    t.isRefetch || !1,
                    o
                  );
                    ...
                    if (t && n === t.latestFetchId) {
                      var a = hn(
                        (function (e, t, n) {
                          ...
                          return o && (e = ni(e, o)), r && (e = ni(e, r)), e;
                        })(o, t, i),
                        t,
                        i
                      );
                      return r && (a = wt(a, r, i)), mn(ri(e, t.sourceId), a);
                    }
                    return e;
            ...
            S = {
              ...
              dateSelection: oi(o.dateSelection, e),
              eventSelection: ii(o.eventSelection, e),
              eventDrag: ai(o.eventDrag, e),
              eventResize: si(o.eventResize, e),
            },
            D = r(r({}, c), S),
            b = 0,
  ...
  function Si(e, t, n, r, o, i, a, s) {
    var l = Nr(t || a.defaultCode, a.map);
    return new xr({
  ...
  function bi(e) {
    return new (e.dateProfileGeneratorClass || Zo)(e);
  }
  function Ci(e, t, n) {
    return new gr(e, t, n);
  }
  ...
  function ki(e) {
    return Lr(e.options.businessHours, e);
  }
  function xi(e, t) {
    for (var n in e)
      console.warn(
      ...
      return (
        ...
        (e.prototype.insertEntryAt = function (e, t) {
          ...
          !n || this.levelCoords[n - 1] < t.levelCoord
            ? (Oi(this.levelCoords, n, t.levelCoord),
              Oi(this.entriesByLevel, n, [e]))
            : Oi(this.entriesByLevel[n - 1], t.lateralEnd, e),
            (this.stackCnts[Ni(e)] = t.stackCnt);
        }),
  ...
  var Vi = {},
    ...
    zi = {},
    Bi = { startTime: kt, duration: kt, create: Boolean, sourceId: String };
  function ji(e) {
    var t = pn(e, Bi),
      n = t.refined,
      r = t.extra;
      ...
      return (
        ...
        (t.prototype.renderWidgetGroup = function (e) {
          for (
            ...
            if ("title" === c)
              (a = !1),
                i.push(vo("h2", { className: "fc-toolbar-title" }, t.title));
            else {
          ...
          if (i.length > 1) {
            ...
            return vo.apply(void 0, o(["div", { className: m }], i));
          }
          return i[0];
        }),
        t
      ...
      function t() {
        ...
        return (
          ...
          (t.handleEl = function (e) {
            (t.el = e), Mo(t.props.elRef, e), t.updateAvailableWidth();
          }),
      ...
      function t(t) {
        ...
        return (
          ...
          (a.removeHoverListeners =
            ...
            (r = a.handleSegEnter),
            (o = a.handleSegLeave),
            xe(n, "mouseover", ".fc-event", function (e, t) {
              if (t !== i) {
                (i = t), r(e, t);
                var n = function (e) {
    ...
    Ki = (function (e) {
      function t() {
        ...
        return (
          ...
          (t.buildViewPropTransformers = Ft(Ji)),
          (t.buildToolbarProps = Ft($i)),
          ...
          (t.registerInteractiveComponent = function (e, n) {
            ...
            (t.interactionsStore[e.uid] = o), (Vi[e.uid] = r);
          }),
          (t.unregisterInteractiveComponent = function (e) {
            for (var n = 0, r = t.interactionsStore[e.uid]; n < r.length; n++)
              r[n].destroy();
            delete t.interactionsStore[e.uid], delete Vi[e.uid];
          }),
          (t.resizeRunner = new gi(function () {
  ...
  var Qi = (function (e) {
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return jr() || i.push("fc-liquid-hack"), e.children(i, o, r, n);
      }),
      (t.prototype.componentDidMount = function () {
  ...
  var ra = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            ...
            u = [ta].concat(Xr(l, o), e.extraClassNames || []),
    ...
    ia = (function (e) {
      function t(t, n) {
        ...
        return (
          (r.initialNowDate = Sr(n.options.now, n.dateEnv)),
  ...
  var sa = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.createDayHeaderFormatter = Ft(la)), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
        ...
        return vo(ia, { unit: "day" }, function (e, t) {
          return vo(
            "tr",
            null,
            i && i("day"),
      ...
      return (
        ...
        (e.prototype._sliceInteraction = function (e, t, n, r) {
          for (var o = [], i = 4; i < arguments.length; i++)
            o[i - 4] = arguments[i];
          if (!e) return null;
          var a = Bn(e.mutatedEvents, t, pa(n, Boolean(r)), r);
          return {
  ...
  function fa(e, t, n) {
    ...
    return va({ eventDrag: e }, n);
  }
  function ha(e, t, n) {
    return !!Fn(t.validRange, e.range) && va({ dateSelection: e }, n);
  }
  function va(e, t) {
    ...
    return (t.pluginHooks.isPropsValid || ga)(o, t);
  }
  function ga(e, t, n, o) {
    return (
      void 0 === n && (n = {}),
      !(
        (e.eventDrag &&
          !(function (e, t, n, o) {
            ...
            var d,
              ...
              h = f.defs,
              v = f.instances,
              g = Yn(h, e.eventUiBases);
            for (var m in u) {
              var y = u[m],
                E = y.range,
                S = c[y.defId],
                D = l[y.defId];
              if (!ma(S.constraints, E, f, e.businessHours, t)) return !1;
              ...
              for (var w in v) {
                ...
                if (Vn(E, R.range)) {
                  ...
                  if (C && !C(new br(t, h[R.defId], R), new br(t, D, y)))
                    return !1;
                }
              }
              for (
                ...
                var x,
                  M = k[T],
                  I = r(r({}, n), { range: y.range, allDay: D.allDay }),
                  P = _.defs[D.defId],
                  N = _.instances[m];
                if (((x = P ? new br(t, P, N) : new br(t, D)), !M(dr(I, t), x)))
                  return !1;
              }
            }
            return !0;
        ...
        (e.dateSelection &&
          !(function (e, t, n, o) {
            ...
            if ((o && (c = o(c)), !ma(c.constraints, u, i, e.businessHours, t)))
              return !1;
            ...
            for (var v = 0, g = c.allows; v < g.length; v++)
              if (!(0, g[v])(dr(r(r({}, n), l), t), null)) return !1;
            return !0;
          })(e, t, n, o))
      )
    );
  ...
  function ma(e, t, n, r, o) {
    for (var i = 0, a = e; i < a.length; i++)
      if (!Sa(ya(a[i], t, n, r, o), t)) return !1;
    return !0;
  }
  ...
  var Da = /^(visible|hidden)$/,
    ba = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.handleEl = function (e) {
            (t.el = e), Mo(t.props.elRef, e);
          }),
          t
        );
      }
      return (
        ...
        (t.prototype.needsXScrolling = function () {
          if (Da.test(this.props.overflowX)) return !1;
          for (
            var e = this.el,
              t =
        ...
        (t.prototype.needsYScrolling = function () {
          if (Da.test(this.props.overflowY)) return !1;
          for (
            var e = this.el,
              t =
  ...
  function _a(e, t) {
    return null != t.maxHeight || Ra(e, t);
  }
  function Ta(e, t, n) {
    var r = n.expandRows;
    ...
    for (var n = [], r = 0, i = e; r < i.length; r++)
      for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1)
        n.push(
          vo("col", {
            style: {
              width: "shrink" === a.width ? Ma(t) : a.width || "",
              minWidth: a.minWidth || "",
            },
          })
        );
    return vo.apply(void 0, o(["colgroup", {}], n));
  }
  function Ma(e) {
    return null == e ? 4 : e;
  }
  ...
  var Ua = (function (e) {
    function t() {
      ...
      return (
        ...
        (t.renderMicroColGroup = Ft(xa)),
        (t.scrollerRefs = new Ca()),
        (t.scrollerElRefs = new Ca(t._handleScrollerEl.bind(t))),
        (t.state = {
          shrinkWidth: null,
          forceYScrollbars: !1,
    ...
    return (
      ...
      (t.prototype.render = function () {
        ...
        return vo(
          ...
          Boolean(!v && p.length) && vo.apply(void 0, o(["thead", {}], p)),
          Boolean(!v && f.length) && vo.apply(void 0, o(["tbody", {}], f)),
          Boolean(!v && h.length) && vo.apply(void 0, o(["tfoot", {}], h)),
          v && vo.apply(void 0, o(o(o(["tbody", {}], p), f), h))
        );
      }),
      (t.prototype.renderSection = function (e, t) {
        return "outerContent" in e
          ? vo(yo, { key: e.key }, e.outerContent)
          : vo(
              "tr",
              { key: e.key, className: Na(e, this.props.liquid).join(" ") },
      ...
      (t.prototype.computeShrinkWidth = function () {
        return Ia(this.props.cols) ? wa(this.scrollerElRefs.getAll()) : 0;
      }),
  ...
  Ua.addStateEquality({ scrollerClientWidths: Et, scrollerClientHeights: Et });
  var La = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.elRef = mo()), t;
        ...
        (t.prototype.render = function () {
          ...
          return vo(
            La,
            {
              ...
              defaultContent: e.defaultContent || Va,
  ...
  function Va(e) {
    return vo(
      ...
      e.timeText && vo("div", { className: "fc-event-time" }, e.timeText),
      vo(
        "div",
        ...
        vo(
          ...
          e.event.title || vo(yo, null, " ")
        )
      )
    );
  }
  var Fa = function (e) {
      return vo(wo.Consumer, null, function (t) {
        var n = t.options,
          r = {
            isAxis: e.isAxis,
  ...
  function ja(e) {
    var t = e.date,
      n = e.dateEnv,
      o = Zr(t, e.todayRange, null, e.dateProfile);
    return r(
  ...
  var Ga = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.refineHookProps = zt(ja)), (t.normalizeClassNames = Vo()), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
  ...
  function Za(e) {
    return (
      e.event.title && vo("div", { className: "fc-event-title" }, e.event.title)
    );
  }
  var Xa = function (e) {
    return vo(wo.Consumer, null, function (t) {
      ...
      return (
          ...
          return So(
            vo(
              ...
              vo(
                ...
                vo("span", { className: "fc-popover-title" }, t.title),
                vo("span", {
        ...
        (t.prototype.updateSize = function () {
          var e = this.context.isRtl,
            ...
            i = (function (e) {
              for (
                var t = io(e), n = e.getBoundingClientRect(), r = 0, o = t;
                r < o.length;
                r++
              ) {
                var i = Vr(n, o[r].getBoundingClientRect());
                if (!i) return null;
                n = i;
              }
              return n;
              ...
              Boolean(t.moreCnt) &&
                vo(
                  Oo,
                  {
                    ...
                    defaultContent: t.defaultContent || es,
  ...
  function ts(e) {
    ...
    var t,
      n = e.hiddenSegs;
    return { start: ns(n), end: ((t = n), t.reduce(os).eventRange.range.end) };
  }
  function ns(e) {
    return e.reduce(rs).eventRange.range.start;
  }
  function rs(e, t) {
  ...
  var is = (function (e) {
    function t(t, n) {
      ...
      return (
                ...
                function (t, n, i, a) {
                  return (
                    ...
                    vo(
                      ...
                      vo(Ki, r({ isHeightAuto: i, forPrint: a }, e))
                    )
                  );
                }
              ),
        ...
        (o.el = t),
        (o.renderRunner = new gi(o.handleRenderRequest)),
        new Ei({
          optionOverrides: n,
          calendarApi: o,
    ...
    return (
      ...
      (t.prototype.updateSize = function () {
        e.prototype.updateSize.call(this), Do();
      }),
    ...
    us = (function () {
      function e(e) {
        ...
        (this.subjectEl = null),
          ...
          1 === (ss += 1) &&
            window.addEventListener("touchmove", cs, { passive: !1 });
      }
      return (
        (e.prototype.destroy = function () {
          this.containerEl.removeEventListener(
            ...
            (ss -= 1) ||
              window.removeEventListener("touchmove", cs, { passive: !1 });
        }),
  ...
  var ds = (function () {
      ...
      return (
        ...
        (e.prototype.handleMove = function (e, t) {
          if (this.isEnabled) {
            ...
            o < 0
              ...
              this.isAnimating ||
                ((this.isAnimating = !0), this.requestAnimation(vs()));
          }
        }),
        ...
        (e.prototype.buildCaches = function () {
          return this.queryScrollEls().map(function (e) {
            return e === window ? new hs(!1) : new fs(e, !1);
          });
        }),
    ...
    ys = (function () {
      function e(e) {
        (this.origRect = oo(e)),
          (this.scrollCaches = io(e).map(function (e) {
            return new fs(e, !0);
          }));
      }
      return (
          ...
          for (var i in n) {
            ...
            if (s && s.isWithinClipping(e, t)) {
              ...
              if (c >= 0 && c < f && d >= 0 && d < h) {
                ...
                v &&
                  Fn(v.dateProfile.activeRange, v.dateSpan.range) &&
                  (!o || v.layer > o.layer) &&
                  ((v.componentId = i),
                  (v.context = a.context),
                  (v.rect.left += l),
  ...
  function Ss(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && ar(e.dateSpan, t.dateSpan))
    );
  }
  function Ds(e, t) {
    for (
  ...
  var bs = (function (e) {
      function t(t) {
        ...
        (n.handlePointerDown = function (e) {
          ...
          (n.dragging = new ms(t.el)),
          (n.dragging.autoScroller.isEnabled = !1);
        var o = (n.hitDragging = new Es(n.dragging, Wi(t)));
        return (
          ...
          (n.handleHitUpdate = function (e, t) {
            ...
            if (e) {
              ...
              (e.componentId === s.componentId &&
                ...
                (i && ha(i, e.dateProfile, o)) || ((a = !0), (i = null));
            }
            i
      ...
      function t(n) {
        ...
        (o.subjectEl = null),
          ...
          (o.handlePointerDown = function (e) {
            ...
            var u = (o.subjectSeg = qn(e.subjectEl)),
              ...
              if (e) {
                ...
                i === a || (d.editable && d.droppable)
                  ? (s = (function (e, t, n) {
                    ...
                    ((l = fr(n, a.getCurrentData().eventUiBases, s, a)),
                    (c.mutatedEvents = l),
                    fa(c, e.dateProfile, a) ||
                      ((u = !0),
                      (s = null),
                      (l = null),
        ...
        (n.draggingSegEl = null),
          ...
          (n.handleHitUpdate = function (e, t, r) {
            ...
            e &&
              ...
              l &&
                ((u = fr(i, o.getCurrentData().eventUiBases, l, o)),
                (d.mutatedEvents = u),
                fa(d, e.dateProfile, o) ||
    ...
    _s = (function () {
      function e(e) {
        ...
        (this.context = e),
          ...
          (this.onDocumentPointerDown = function (e) {
            ...
            (t.matchesCancel = !!Se(r, n)),
              (t.matchesEvent = !!Se(r, ws.SELECTOR));
          }),
        ...
        var n = (this.documentPointer = new us(document));
    ...
    xs = (function () {
      function e(e, t) {
            ...
            e &&
              ...
              n.canDropElOnCalendar(o.subjectEl, a) &&
                ((s = (function (e, t, n) {
                  ...
                  return {
                    def: u,
                    instance: pt(u.defId, { start: c, end: d }),
                  };
                })(e.dateSpan, n.dragMeta, a)),
                (u.mutatedEvents = vn(s)),
                (l = !fa(u, e.dateProfile, a)) &&
        ...
        var o = (this.hitDragging = new Es(e, Vi));
        (o.requireInitial = !1),
  ...
  var Ms = (function () {
    ...
    Ns = Po({
      componentInteractions: [bs, Cs, ws, Rs],
      calendarInteractions: [_s],
      elementDraggingImpl: ms,
      optionRefiners: Ts,
      listenerRefiners: ks,
    }),
    Hs = (function (e) {
      ...
      return (
        ...
        (t.prototype.renderSimpleLayout = function (e, t) {
          ...
          return (
            ...
            vo(Bo, { viewSpec: r.viewSpec }, function (e, t) {
              return vo(
                "div",
        ...
        (t.prototype.renderHScrollLayout = function (e, t, n, r) {
          ...
          var i = this.props,
            a = this.context,
            s = !i.forPrint && Oa(a.options),
            l = !i.forPrint && Aa(a.options),
            u = [];
          return (
            e &&
              u.push({
            ...
            l &&
              u.push({
                ...
                key: "footer",
                isSticky: !0,
                chunks: [{ key: "main", content: Ha }],
              }),
            vo(Bo, { viewSpec: a.viewSpec }, function (e, t) {
              return vo(
                "div",
                { ref: e, className: ["fc-daygrid"].concat(t).join(" ") },
                vo(o, {
      ...
      (t.prototype.render = function () {
        var e = this.props,
          t = this.context.options.navLinks
            ? { "data-navlink": Kr(e.date), tabIndex: 0 }
            : {};
        return vo(
          Ba,
          {
    ...
    Bs = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            t = this.context,
            n = t.options.eventTimeFormat || Vs,
            ...
            function (t, n, o, i) {
              return vo(
                ...
                r(
                  ...
                  (a = e.seg.eventRange.def.url) ? { href: a } : {}
                ),
                i
              );
              var a;
    ...
    Zs = (function (e) {
      function t() {
        ...
        return (
          (t.rootElRef = mo()),
          (t.handleRootEl = function (e) {
            Mo(t.rootElRef, e), Mo(t.props.elRef, e);
          }),
          t
        );
      }
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            s = t.dateProfile,
            l = i.navLinks
              ? { "data-navlink": Kr(a, "week"), tabIndex: 0 }
              : {};
          return vo(
            Ga,
            {
            ...
            function (e, n, i, u) {
              return vo(
                ...
                vo(
                  ...
                  vo("div", { className: "fc-daygrid-day-bg" }, t.bgContent)
                )
              );
            }
          );
  ...
  function Xs(e, t, n, o) {
    ...
    var i = e.eventRange,
      a = i.range,
      s = Ln(a, { start: o[t].date, end: Ke(o[n - 1].date, 1) });
    return r(r({}, e), {
      firstCol: t,
      lastCol: n - 1,
      eventRange: {
  ...
  var Ks = (function (e) {
    ...
    $s = (function (e) {
      function t() {
        ...
        return (
          (t.cellElRefs = new Ca()),
          (t.frameElRefs = new Ca()),
          (t.fgElRefs = new Ca()),
          (t.segHarnessRefs = new Ca()),
          (t.rootElRef = mo()),
          (t.state = {
            framePositions: null,
      ...
      return (
        ...
        (t.prototype.render = function () {
          var e = this,
            ...
            o = t.context.options,
            i = n.cells.length,
            a = As(n.businessHourSegs, i),
            s = As(n.bgEventSegs, i),
            l = As(this.getHighlightSegs(), i),
            u = As(this.getMirrorSegs(), i),
                        ...
                        (d += y.levelCoord - c),
                          ...
                          E
                            ? ((d += y.thickness),
                              S &&
                                v.push({
                                  seg: Xs(h, y.spanStart, y.spanEnd, n),
                                  isVisible: !0,
                                  isAbsolute: !0,
          ...
          return vo(
            ...
            n.cells.map(function (t, r) {
              ...
              return vo(Zs, {
                ...
                fgContent: vo(yo, null, vo(yo, null, o), vo(yo, null, i)),
                bgContent: vo(
                  yo,
                  null,
            ...
            for (var l = 0, u = e; l < u.length; l++) {
              ...
              s.push(
                vo(
                  ...
                  "bg-event" === t ? vo(Ya, r({ seg: c }, tr(c, i))) : qa(t)
                )
              );
            }
          return vo.apply(void 0, o([yo, {}], s));
        }),
          ...
          if (!t.forPrint && null !== t.clientWidth) {
            if (e) {
              ...
              if (r.length) {
                ...
                this.setState({ framePositions: new lo(o, r, !0, !1) });
              }
            }
  ...
  $s.addStateEquality({ eventInstanceHeights: Et });
  var Js = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (
        (t.splitBusinessHourSegs = Ft(Os)),
        (t.splitBgEventSegs = Ft(Os)),
        (t.splitFgEventSegs = Ft(Os)),
        (t.splitDateSelectionSegs = Ft(Os)),
        (t.splitEventDrag = Ft(Us)),
        (t.splitEventResize = Ft(Us)),
        (t.rowRefs = new Ca()),
        (t.handleRootEl = function (e) {
          (t.rootEl = e),
            e
  ...
  var el = (function (e) {
    ...
    tl = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.slicer = new el()), (t.tableRef = mo()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
  ...
  function rl(e, t) {
    ...
    return new ca(n, /year|month|week/.test(e.currentRangeUnit));
  }
  var ol = Po({
  ...
  function sl(e) {
    ...
    return vo(wo.Consumer, null, function (n) {
      if (!e.isLabeled)
        return vo("td", { className: t.join(" "), "data-time": e.isoTimeStr });
      var r = n.dateEnv,
        o = n.options,
        i = n.viewApi,
        a =
      ...
      return (
        ...
        (t.prototype.render = function () {
          return this.props.slatMetas.map(function (e) {
            return vo("tr", { key: e.key }, vo(sl, r({}, e)));
          });
        }),
        t
      );
    ...
    dl = (function (e) {
        ...
        return (
          ...
          (t.renderHeadAxis = function (e, n) {
            ...
            var o = t.context.options,
              ...
              s =
                o.navLinks && 1 === a
                  ? { "data-navlink": Kr(i.start, "week"), tabIndex: 0 }
                  : {};
            return o.weekNumbers && "day" === e
              ? vo(
                  Xa,
                  { date: i.start, defaultFormat: cl },
                  function (e, t, o, i) {
                    return vo(
                      "th",
                      {
      ...
      return (
        ...
        (t.prototype.renderHScrollLayout = function (e, t, n, r, o, i, a) {
          ...
          var u = this.context,
            c = this.props,
            d = !c.forPrint && Oa(u.options),
            p = !c.forPrint && Aa(u.options),
            f = [];
          e &&
            f.push({
              type: "header",
                  ...
                  content: function (e) {
                    return vo(
                      ...
                      vo(
                        ...
                        e.tableColGroupNode,
                        vo("tbody", null, vo(ul, { slatMetas: i }))
                      ),
                      vo(
                        "div",
                        { className: "fc-timegrid-now-indicator-container" },
                        vo(ia, { unit: h ? "minute" : "day" }, function (e) {
  ...
  var fl = (function () {
    ...
    vl = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (t.rootElRef = mo()), (t.slatElRefs = new Ca()), t;
      }
      return (
        n(t, e),
        (t.prototype.render = function () {
  ...
  function Dl(e, t) {
    ...
    for (
      ...
      a.push(t(n, i)), (i += 1);
    return a.sort(bl), [a.map(Cl), a[0][1]];
  }
  function bl(e, t) {
    return t[1] - e[1];
  }
  ...
  var Rl = nn({ hour: "numeric", minute: "2-digit", meridiem: !1 }),
    _l = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            vo(
              Wa,
              r({}, this.props, { defaultTimeFormat: Rl, extraClassNames: e })
            )
          );
        }),
        t
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return vo(
            ...
            function (e, t) {
              return (
                t && vo("div", { className: "fc-timegrid-col-misc", ref: e }, t)
              );
            }
          );
        }),
    ...
    kl = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.sortEventSegs = Ft(Xn)), (t.computeFgSegPlacements = Ft(Sl)), t
        );
      }
      return (
        n(t, e),
        ...
        (t.prototype.renderPositionedFgSegs = function (e, t, n, o, i) {
          var a = this,
            ...
            m = v ? Sl(g) : this.computeFgSegPlacements(g, c, l),
            y = m.segRects,
            E = m.hiddenGroups;
          return vo(
            yo,
        ...
        (t.prototype.renderFillSegs = function (e, t) {
          ...
          var i = this.buildSegInputs(e).map(function (i) {
            ...
            return vo(
              ...
              "bg-event" === t
                ? vo(Ya, r({ seg: a }, tr(a, o.todayRange, o.nowDate)))
                : qa(t)
            );
          });
          return vo(yo, null, i);
  ...
  var Ml = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          (t.splitFgEventSegs = Ft(gl)),
          (t.splitBgEventSegs = Ft(gl)),
          (t.splitBusinessHourSegs = Ft(gl)),
          (t.splitNowIndicatorSegs = Ft(gl)),
          (t.splitDateSelectionSegs = Ft(gl)),
          (t.splitEventDrag = Ft(ml)),
          (t.splitEventResize = Ft(ml)),
          (t.rootElRef = mo()),
          (t.cellElRefs = new Ca()),
          t
        );
    ...
    Hl = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return vo(ia, { unit: a ? "minute" : "day" }, function (l, u) {
            return vo(
              Il,
    ...
    for (
      var i = new Date(0),
        ...
        l =
          ...
          (function (e) {
            var t, n, r;
            for (t = Al.length - 1; t >= 0; t -= 1)
              if (null !== (r = Ht((n = kt(Al[t])), e)) && r > 1) return n;
            return e;
          })(r),
        u = [];
      Nt(a) < Nt(t);
  ...
  var Ll = (function (e) {
    function t() {
      var t = (null !== e && e.apply(this, arguments)) || this;
      return (t.buildTimeColsModel = Ft(Wl)), (t.buildSlatMetas = Ft(Ul)), t;
    }
    return (
      n(t, e),
      (t.prototype.render = function () {
  ...
  function zl(e) {
    ...
    return vo(
      yo,
      null,
      e.text && vo("a", r({ className: "fc-list-day-text" }, t), e.text),
      e.sideText &&
        vo("a", r({ className: "fc-list-day-side-text" }, t), e.sideText)
    );
  }
  var Bl = nn({ hour: "numeric", minute: "2-digit", meridiem: "short" }),
    jl = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      return (
        ...
        (t.prototype.render = function () {
          var e = this.props,
            t = this.context,
            n = e.seg,
            r = t.options.eventTimeFormat || Bl;
          return vo(
            La,
            {
              seg: n,
            ...
            function (e, o, i, a, s) {
              return vo(
                ...
                (function (e, t, n) {
                  ...
                  if (!1 !== r.displayEventTime) {
                    ...
                    if (
                      (o.allDay
                        ? (a = !0)
                        : Hn(e.eventRange.range)
                        ? e.isStart
                          ? (s = er(e, t, n, null, null, i.range.start, e.end))
                          : e.isEnd
                          ? (s = er(e, t, n, null, null, e.start, i.range.end))
                          : (a = !0)
                        : (s = er(e, t, n)),
                      a)
                    ) {
                    ...
                    return vo("td", { className: "fc-list-event-time" }, s);
                  }
                  return null;
                })(n, r, t),
                vo(
                ...
                vo("td", { className: "fc-list-event-title", ref: i }, a)
              );
            }
          );
        }),
  ...
  function Gl(e) {
    var t = e.event,
      n = t.url;
    return vo("a", r({}, n ? { href: n } : {}), t.title);
  }
  function ql(e) {
    return e.text;
  }
  var Yl = (function (e) {
    ...
    return (
        ...
        return vo(
          ...
          function (e, t, n, r) {
            return vo(
              ...
              vo("div", { className: "fc-list-empty-cushion", ref: n }, r)
            );
          }
        );
      }),
      (t.prototype.renderSegList = function (e, t) {
        ...
        return vo(ia, { unit: "day" }, function (e, n) {
          for (var s = [], l = 0; l < a.length; l += 1) {
            var u = a[l];
            if (u) {
              var c = t[l].toISOString();
              s.push(vo(Fl, { key: c, dayDate: t[l], todayRange: n }));
              for (
                var d = 0, p = (u = Xn(u, i.eventOrder));
                d < p.length;
                d++
              ) {
                var f = p[d];
  ...
  (Jl.prototype.classes = {
    ...
    (Jl.prototype.baseIconClass = "fa"),
    (Jl.prototype.iconClasses = {
      close: "fa-times",
    ...
    (Jl.prototype.rtlIconClasses = {
      prev: "fa-chevron-right",
      next: "fa-chevron-left",
      prevYear: "fa-angle-double-right",
      nextYear: "fa-angle-double-left",
    }),
    (Jl.prototype.iconOverrideOption = "bootstrapFontAwesome"),
    (Jl.prototype.iconOverrideCustomButtonOption = "bootstrapFontAwesome"),
    (Jl.prototype.iconOverridePrefix = "fa-");
  var Ql = Po({ themeClasses: { bootstrap: Jl } }),
    eu = Po({
      eventSourceDefs: [
        {
          parseMeta: function (e) {
  ...
  return (
    ...
    (e.Calendar = is),
    (e.CalendarApi = Dr),
    (e.CalendarContent = Ki),
    (e.CalendarDataManager = Ei),
    (e.CalendarDataProvider = Mi),
    (e.CalendarRoot = Qi),
    (e.Component = ho),
    (e.ContentHook = Uo),
    (e.CustomContentRenderContext = Ao),
    (e.DateComponent = Io),
    (e.DateEnv = xr),
    (e.DateProfileGenerator = Zo),
    (e.DayCellContent = Ba),
    (e.DayCellRoot = Ga),
    (e.DayGridView = nl),
    (e.DayHeader = sa),
    ...
    (e.DayTableSlicer = el),
    (e.DayTimeCols = Hl),
    (e.DayTimeColsSlicer = Nl),
    (e.DayTimeColsView = Ll),
    (e.DelayedRunner = gi),
    (e.Draggable = Ms),
    ...
    (e.EventRoot = La),
    (e.EventSourceApi = ye),
    (e.FeaturefulElementDragging = ms),
    (e.Fragment = yo),
    (e.Interaction = Ui),
    (e.ListView = Yl),
    (e.MoreLinkRoot = Qa),
    ...
    (e.NowIndicatorRoot = Fa),
    (e.NowTimer = ia),
    (e.PointerDragging = us),
    (e.PositionCache = lo),
    (e.RefMap = Ca),
    (e.RenderHook = Oo),
    (e.ScrollController = uo),
    (e.ScrollResponder = Co),
    (e.Scroller = ba),
    (e.SegHierarchy = Ii),
    (e.SimpleScrollGrid = Ua),
    (e.Slicer = da),
    (e.Splitter = qr),
    (e.StandardEvent = Wa),
    (e.Table = Js),
    ...
    (e.TableView = Hs),
    (e.Theme = fo),
    (e.ThirdPartyDraggable = Ps),
    (e.TimeCols = Il),
    (e.TimeColsSlatsCoords = fl),
    (e.TimeColsView = dl),
    (e.ViewApi = gr),
    (e.ViewContextType = wo),
    (e.ViewRoot = Bo),
    (e.WeekNumberRoot = Xa),
    (e.WindowScrollController = po),
    (e.addDays = Ke),
    (e.addDurations = Mt),
    (e.addMs = $e),
    (e.addWeeks = Xe),
    ...
    (e.allowSelection = Ue),
    (e.applyMutationToEventStore = fr),
    (e.applyStyle = we),
    (e.applyStyleProp = Re),
    ...
    (e.buildDayRanges = Ol),
    (e.buildDayTableModel = rl),
    (e.buildEntryKey = Ni),
    (e.buildEventApis = wr),
    (e.buildEventRangeKey = rr),
    ...
    (e.buildIsoString = At),
    (e.buildNavLinkData = Kr),
    (e.buildSegCompareObj = Kn),
    (e.buildSegTimeText = er),
    (e.buildSlatMetas = Ul),
    (e.buildTimeColsModel = Wl),
    ...
    (e.compareNumbers = Ge),
    (e.compareObjs = Dt),
    (e.computeEarliestSegStart = ns),
    (e.computeEdges = no),
    (e.computeFallbackHeaderFormat = ea),
    ...
    (e.computeInnerRect = ro),
    (e.computeRect = oo),
    (e.computeSegDraggable = $n),
    (e.computeSegEndResizable = Qn),
    (e.computeSegStartResizable = Jn),
    (e.computeShrinkWidth = wa),
    (e.computeSmallestCellWidth = Ye),
    (e.computeVisibleDayRange = Nn),
    (e.config = zi),
    (e.constrainPoint = Fr),
    (e.createContext = Eo),
    (e.createDuration = kt),
    ...
    (e.getAllowYScrolling = _a),
    (e.getCanVGrowWithinCell = jr),
    (e.getClippingParents = io),
    (e.getDateMeta = Zr),
    (e.getDayClassNames = Xr),
    (e.getDefaultEventEnd = pr),
    (e.getElSeg = qn),
    (e.getEntrySpanEnd = Pi),
    (e.getEventClassNames = nr),
    (e.getIsRtlScrollbarOnLeft = Qr),
    (e.getRectCenter = zr),
    (e.getRelevantEvents = gn),
    (e.getScrollGridClassNames = Pa),
    (e.getScrollbarWidths = eo),
    (e.getSectionClassNames = Na),
    (e.getSectionHasLiquidHeight = Ra),
    (e.getSegMeta = tr),
    ...
    (e.getStickyFooterScrollbar = Aa),
    (e.getStickyHeaderDates = Oa),
    (e.getUnequalProps = St),
    (e.globalLocales = Mr),
    (e.globalPlugins = fi),
    (e.greatestDurationDenominator = Ot),
    (e.groupIntersectingEntries = Hi),
    (e.guid = Ne),
    (e.hasBgRendering = jn),
    (e.hasShrinkWidth = Ia),
    (e.identity = fn),
    (e.interactionSettingsStore = Vi),
    (e.interactionSettingsToStore = Wi),
    (e.intersectRanges = Ln),
    (e.intersectRects = Vr),
    (e.isArraysEqual = Vt),
    (e.isColPropsEqual = ka),
    (e.isDateSelectionValid = ha),
    (e.isDateSpansEqual = ar),
    (e.isInt = qe),
    (e.isInteractionValid = fa),
    (e.isMultiDayRange = Hn),
    (e.isPropsEqual = Et),
    (e.isPropsValid = ga),
    (e.isValidDate = ct),
    ...
    (e.memoizeObjArg = zt),
    (e.mergeEventStores = mn),
    (e.multiplyDuration = It),
    (e.padStart = je),
    (e.parseBusinessHours = Lr),
    (e.parseClassNames = En),
    (e.parseDragMeta = ji),
    (e.parseEventDef = In),
    (e.parseFieldSpecs = Ve),
    (e.parseMarker = kr),
    (e.pointInsideRect = Wr),
    (e.preventContextMenu = Le),
    (e.preventDefault = Te),
    (e.preventSelection = Ae),
    (e.rangeContainsMarker = zn),
    (e.rangeContainsRange = Fn),
    (e.rangesEqual = Wn),
    (e.rangesIntersect = Vn),
    (e.refineEventDef = xn),
    (e.refineProps = pn),
    (e.removeElement = Ee),
    ...
    (e.renderFill = qa),
    (e.renderMicroColGroup = xa),
    (e.renderScrollShim = Ha),
    (e.requestJson = ci),
    (e.sanitizeShrinkWidth = Ma),
    (e.setElSeg = Gn),
    (e.setRef = Mo),
    ...
    (e.triggerDateSelect = cr),
    (e.unmountComponentAtNode = bo),
    (e.unpromisify = ao),
    (e.version = "5.7.2"),
